            ...
            <div className="p-6 md:p-10 max-h-[90vh] overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-stone-300 [&::-webkit-scrollbar-thumb]:rounded-full relative z-0">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
                ...
                <div className="lg:col-span-5 flex flex-col gap-4 md:gap-5">
                  <h3 className="text-[10px] uppercase tracking-widest text-stone-400 font-bold mb-1 ml-1 hidden md:block">Order Details</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
                    <div className="bg-stone-50/80 border border-stone-100 rounded-2xl p-5 flex flex-col justify-center transition-all hover:bg-stone-50 shadow-sm relative overflow-hidden">
                      ...
                      <span className="text-[10px] uppercase tracking-widest font-bold text-stone-400 mb-1.5">Event Date</span>
                      <span className="text-sm font-semibold text-stone-800">{new Date(selectedOrder.eventDate).toLocaleDateString('fr-FR', { weekday: 'long', day: 'numeric', month: 'long' })}</span>
                    </div>
                    <div className="bg-stone-50/80 border border-stone-100 rounded-2xl p-5 flex flex-col justify-center transition-all hover:bg-stone-50 shadow-sm relative overflow-hidden">
                      <div className="absolute top-0 left-0 w-1 h-full bg-stone-200/50" />
                      <span className="text-[10px] uppercase tracking-widest font-bold text-stone-400 mb-1.5">Phone Number</span>
                      <span className="text-sm font-semibold text-stone-800">{selectedOrder.phoneNumber}</span>
                    </div>
                    <div className="bg-stone-50/80 border border-stone-100 rounded-2xl p-5 flex flex-col justify-center transition-all hover:bg-stone-50 shadow-sm relative overflow-hidden">
                      <div className="absolute top-0 left-0 w-1 h-full bg-stone-200/50" />
                      <span className="text-[10px] uppercase tracking-widest font-bold text-stone-400 mb-1.5">Cake Size</span>
                      <span className="text-sm font-semibold text-stone-800">{selectedOrder.cakeSize}</span>
                    </div>
                    <div className="bg-stone-50/80 border border-stone-100 rounded-2xl p-5 flex flex-col justify-center transition-all hover:bg-stone-50 shadow-sm relative overflow-hidden">
                      <div className="absolute top-0 left-0 w-1 h-full bg-stone-200/50" />
                      <span className="text-[10px] uppercase tracking-widest font-bold text-stone-400 mb-1.5">Flavor</span>
                      <span className="text-sm font-semibold text-stone-800">{selectedOrder.flavor}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:col-span-7 flex flex-col">
                  <div className="flex items-center justify-between mb-4 px-1">
                    <span className="text-[10px] uppercase tracking-widest text-stone-400 font-bold hidden md:block">Design Reference</span>
